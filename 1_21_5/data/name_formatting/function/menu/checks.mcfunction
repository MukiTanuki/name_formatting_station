...
execute if entity @s[scores={FormatName=500..501}] store result score #size2 nfs_dummy run data get entity @s equipment.offhand.components.minecraft:custom_name
...
execute if entity @s[scores={FormatName=701..702}] store result score #size2 nfs_dummy run data get entity @s equipment.offhand.components.minecraft:custom_name
...
execute if entity @s[scores={FormatName=704..705}] store result score #lore nfs_dummy run data get entity @s equipment.offhand.components.minecraft:lore
