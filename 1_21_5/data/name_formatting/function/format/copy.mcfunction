...
execute as @s[scores={FormatName=610}] run data modify storage name_formatting:item_lore Lore set from entity @s equipment.offhand.components.minecraft:lore
