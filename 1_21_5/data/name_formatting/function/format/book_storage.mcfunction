...
execute if data entity @s equipment.offhand.tag.display.Lore run data modify storage name_formatting:item_lore Lore append from entity @s equipment.offhand.tag.display.Lore[]
# delete last
