...
execute if entity @s[predicate=name_formatting:mainhand_book] run data modify storage name_formatting:item_data NameFormat.ModifiedName set from entity @s equipment.offhand.tag.display.Name
# sets format data
